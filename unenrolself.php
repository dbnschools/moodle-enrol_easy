...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'easy'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/easy/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_easy', format_string($course->fullname));
